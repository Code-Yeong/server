let orderSql = {
    ...
    "barberComment" : "select r.comment, r.commentTime, r.cusId, u.avatar as cusAvatr, u.sex as cusSex,r.barberScore as starCount,s.avatar as shopAvatar, s.name as shopName, r.servename from Barber b, User u, Reservation r, Shop s where b.id=r.barberId and u._id=r.cusId and s.id=r.shopId and r.barberId=? order by r.commentTime DESC;",
};
